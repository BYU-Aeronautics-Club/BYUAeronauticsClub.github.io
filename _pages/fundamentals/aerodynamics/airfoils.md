...
Let's take a look at another polar. This one shows the coefficient of lift (C<sub>l</sub>) as a function of the coefficient of drag (C<sub>d</sub>). This is useful mostly in helping us to determine the maximum lift over drag ratio, or L/D. If you draw a straight line from the origin upward, then pivot it until it touches the polar, the slope is the airfoil's theoretical maximum L/D. The lift over drag ratio is a common way to determine the optimum flight scenario for your UAV because it provides the highest efficiency in terms of lift and drag. Other performance concepts will be discussed [elsewhere](https://aeronautics.byu.edu/fundamentals/aerodynamics/performance/).
